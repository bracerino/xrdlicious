...
def show_citation_section():
    with st.expander("How to Cite", icon="📚", expanded=True):
        ...
        - Cite the **relevant database**:
            ...
            - **Materials Cloud Three-Dimensional Structure Database (MC3D)** [S. P. Huber et al., MC3D: The materials cloud computational database of experimentally known stoichiometric inorganics, Digital Discovery 5, 1114 (2026)](https://doi.org/10.1039/D5DD00309A).
