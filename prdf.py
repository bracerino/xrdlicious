...
with col2:
    st.info(
        ...
        "**lebedmi2@cvut.cz**. To compile the app locally, visit the **[GitHub page](https://github.com/bracerino/xrdlicious)**. If you like the app, please cite our **[article in IUCr](https://journals.iucr.org/j/issues/2025/05/00/hat5006/index.html).**"
    )
